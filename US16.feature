Feature: US16: Reservar servicio del guía
    Scenario: Realizar reserva del servicio de un guía
        Given que el turista ha encontrado un guía adecuado para su viaje
    ...
    Scenario: Cancelar reserva del servicio de un guía
        Given que el turista decidió que no quiere realizar su visita turista con el guía, por alguna razón
